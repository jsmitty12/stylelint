...
testRule({
	ruleName,
	config: ['never', { ignore: ['custom-property-fallbacks'] }],
	...
	accept: [
		...
		{
			code: 'a { color: var(--foo, red, blue); }',
			description: 'multiple named colors as var() fallback',
		},
		{
			code: 'a { color: #000; }',
			description: 'hex colors are not affected',
		},
		{
			code: 'a { color: var(--some-color-blue); }',
			description: 'ignore css variable named with color',
	...
	reject: [
		...
		},
		{
			...
			description: 'named color outside var() is still flagged',
			message: messages.rejected('red'),
			line: 1,
			column: 12,
			endLine: 1,
		...
		},
		{
			...
			description: 'named color as var() argument (not a fallback) is still flagged',
			message: messages.rejected('red'),
			line: 1,
			column: 16,
			endLine: 1,
...
testRule({
	ruleName,
	config: ['always-where-possible', { ignore: ['custom-property-fallbacks'] }],
	...
	reject: [
		{
			code: 'a { color: #000; }',
			description: 'hex color outside var() is still flagged',
			message: messages.expected('#000', 'black'),
			line: 1,
			column: 12,
			endLine: 1,

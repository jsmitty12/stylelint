...
testRule({
	ruleName,
	config: [true, { ignore: ['custom-property-fallbacks'] }],

	accept: [
		{
			code: 'a { color: var(--my-variable, #ffffff); }',
		},
		{
		...
		{
			code: 'a { color: var(--foo, linear-gradient(#fff, #000)); }',
		},
		{
